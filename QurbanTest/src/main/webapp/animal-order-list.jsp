				...
				<tbody>
					...
					<c:forEach var="animalOrder" items="${listAnimalOrder}">
						...
						<tr>
							...
							<td><a href="edit?animalOrderID=<c:out value='${animalOrder.animalOrderID}' />">Ubah Pembekal</a>
								&nbsp;&nbsp;&nbsp;&nbsp; <a
								href="delete?animalOrderID=<c:out value='${animalOrder.animalOrderID}' />">Padam</a></td>
						</tr>
					</c:forEach>
					<!-- } -->
				</tbody>
